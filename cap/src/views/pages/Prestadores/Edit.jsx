...
const Edit = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            let data = await window.api.Action({ controller: "Prestadores", action: "GetPrestador", params: { id: id } });
            data = data[0];
            setImage(data.image);
            ...
            setPrestador({
                ...
                dt_nascimento: data.dt_nascimento.toLocaleDateString('en-CA'),
                ...
                possui_beneficios: data.possui_beneficios,
            ...
            customUI: ({ onClose }) => {
                return (
                    <div className='custom-ui'>
                        ...
                        <p>Deseja salvar as alterações do prestador <b>{prestador.nome}</b>?</p>
                        ...
                        <button className='btn btn-confirm modal-btn'
                            onClick={async () => {
                                ...
                                const postResult = await window.api.Action({ controller: "Prestadores", action: "Edit", params: payload });
    ...
    const addBeneficio = () => {
        ...
        lista_beneficios.push({ nome: beneficios });
        setPrestador({
            ...prestador,
