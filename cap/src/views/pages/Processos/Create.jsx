...
const Create = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            let data = await window.api.Action({ controller: "Processos", action: "GetPrestador", params: { id: id } });
            setPrestador(data.dataValues.nome);
            ...
            customUI: ({ onClose }) => {
                return (
                    <div className='custom-ui'>
                        ...
                        <p>Confirma a criação de processo para o prestador <b>{prestador}</b>?</p>
                        ...
                        <button className='btn btn-confirm modal-btn'
                            onClick={async () => {
                                ...
                                const postResult = await window.api.Action({ controller: "Processos", action: "Create", params: payload });
